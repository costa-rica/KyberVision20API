...
export const sendRegistrationEmail = async (toEmail: string, username: string): Promise<any> => {
  try {
    const templatePath = path.join("./src/templates/registrationConfirmationEmail.html");
...
export const sendResetPasswordEmail = async (toEmail: string, resetLink: string): Promise<any> => {
  try {
    const templatePath = path.join("./src/templates/resetPasswordLinkEmail.html");
...
export const sendVideoMontageCompleteNotificationEmail = async (
  ...
  try {
    const templatePath = path.join(__dirname, "../templates/videoMontageCompleteNotificationEmail.html");
...
export const sendJoinSquadNotificationEmail = async (toEmail: string): Promise<any> => {
  console.log("-- sendJoinSquadNotificationEmail --");
  try {
    const templatePath = path.join(__dirname, "../templates/requestToRegisterEmail.html");
