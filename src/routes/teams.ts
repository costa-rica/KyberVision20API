...
router.post("/update-visibility", authenticateToken, async (req: Request, res: Response) => {
...
router.post("/add-player", authenticateToken, async (req: Request, res: Response) => {
...
// DELETE /teams/player
router.delete("/player", authenticateToken, async (req: Request, res: Response) => {
