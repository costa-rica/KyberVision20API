...
router.post("/create/:teamId", authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.post("/add-squad-member", authenticateToken, async (req: Request, res: Response) => {
  console.log("------- > accessed POST /contract-team-users/add-squad-member");
  try {
...
router.get(
  ...
  async (req: Request, res: Response) => {
    console.log("- accessed GET /contract-team-users/create-join-token/:teamId");
    const teamId = Number(req.params.teamId);
...
router.get("/join/:joinToken", authenticateToken, async (req: Request, res: Response) => {
  console.log("- accessed GET /contract-team-users/join/:joinToken");
  const joinToken = req.params.joinToken;
  jwt.verify(joinToken, process.env.JWT_SECRET!, async (err, decoded: any) => {
...
router.post("/toggle-role", authenticateToken, async (req: Request, res: Response) => {
